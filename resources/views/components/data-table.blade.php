...
@if(request()->routeIs('data-table-flights'))
    ...
    <div class="flex justify-center mt-6 space-x-6">
        ...
        <div
            ...
            <h3 class="text-lg font-medium text-gray-800 dark:text-gray-200 mb-4">Place an Order</h3>
            ...
            <form action="" method="POST" class="space-y-4">
                ...
                <div>
                    <label for="arrival_city_id"
                           class="block text-sm font-medium text-gray-700 dark:text-gray-300">Arrival City ID</label>
